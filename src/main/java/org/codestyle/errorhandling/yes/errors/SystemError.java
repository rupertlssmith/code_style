 ...
 * an interface that both types can implement, that provides the error code and message.
 *
 * <p/>A system exception is strictly for the attention of the sys admin, never the end user. System exceptions should
 * only appear in application or framework code of systems. When writing library code, stick to
 * {@link UserException}s to inform the user of your API about expected error conditions.
 *
